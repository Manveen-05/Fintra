...
const LogoIcon = ({
  ...
  <div
    className={`w-9 h-9 flex items-center justify-center rounded-full font-bold text-light-text dark:text-white text-sm ${className}`}
  >
    {letter}
  </div>
);
...
export default function FinancialDashboardDemo() {
  return (
    <div className="bg-[#8EB69B] dark:bg-[#0B0D10] min-h-screen flex items-center justify-center p-4">
      <FinancialDashboard
